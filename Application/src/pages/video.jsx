    ...
    <>
      ...
      <div className="my-16">
        <div className="d-flex  mb-16">
          <div
            className="w-full p-10 m-16 "
            style={{ margin: "150px 100px 220px 220px " }}
          >
            <h1
              className="display-2  font-link "
              style={{ fontWeight: "bolder", marginBottom: "60px" }}
            >
              video interview.
            </h1>
            ...
            <div className="fs-4 mb-16" style={{ width: "60%" }}>
              <p>
                Use the video interview simulator and get feedback on how our
                algorithm interprets your facial emotions compared to other
                candidates.
              </p>
              <br />
              ...
              <p style={{ fontWeight: "lighter" }}>
                Anger | Happiness | Fear | Sadness | Surprise | Disgust
              </p>
            </div>
            <br />
            <br />
            ...
            <div className=" gap-2">
              <Link to="/interview/v">
                <button
                  type="button"
                  class="btn btn-dark px-3 mr-4 py-2"
                  style={{ margin: "20px" }}
                >
                  Interview
                </button>
